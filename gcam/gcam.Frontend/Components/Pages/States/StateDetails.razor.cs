using gcam.Frontend.Components.Pages.Cities;
...
public partial class StateDetails
{
    ...
    private async Task DeleteAsync(City city)
    {
        var parameters = new DialogParameters
            {
                { "Message", $"¿Estás seguro que quieres eliminar la ciudad {city.Name}?" }
            };
        ...
        await LoadAsync();
        await table.ReloadServerData();
        Snackbar.Add("Ciudad " + city.Name + " eliminada.", Severity.Success);
    }
}